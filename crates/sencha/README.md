> This is the Copper-derived `cu29` facade used by Sencha. For this fork's setup, implementation status, and research direction, see the [Sencha README](../../README.md). The upstream Copper overview below is retained for attribution and context.
