...
mod imp {
    ...
    pub use cu29_unifiedlog::DefaultSectionStorage;
...
pub trait CuStdApplication:
    CuApplication<DefaultSectionStorage, cu29_unifiedlog::UnifiedLoggerWrite>
{
}

#[cfg(feature = "std")]
impl<T> CuStdApplication for T where
    T: CuApplication<DefaultSectionStorage, cu29_unifiedlog::UnifiedLoggerWrite>
{
}
